...
export default async function JoinPage({ params }: Props) {
  ...
  const deepLink = `rds://join/${encodeURIComponent(cleanCode)}`;
  ...
  return (
    ...
    >
      ...
      <p className="text-white/70 mb-10 max-w-sm text-base">
        Rejoins Renard des Surfaces, le jeu de la Coupe du Monde, et profite de ton parrainage.
      </p>
      ...
      <p className="text-white/40 text-xs">
        Code parrain&nbsp;: <span className="font-semibold tracking-[0.2em] text-white/70">{cleanCode}</span>
      </p>
